...
AssetLoader2::AssetLoader2() {
    loading = false;
    thread = std::thread(AssetLoader2::run, this);
}
...
void AssetLoader2::loadBlocking() {
...
bool AssetLoader2::isLoading() {
    return loading;
}

void AssetLoader2::update() {
...
void AssetLoader2::setGame(std::shared_ptr<IGame> game) {
    this->game = game;
}

double AssetLoader2::getProgress() {
    return 0;
}

void AssetLoader2::addLoadTask(ILoadTask* task) {
    loadTasks.push_back(task);
}

void AssetLoader2::loadAsync()
{
