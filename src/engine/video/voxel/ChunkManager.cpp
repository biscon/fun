...
void ChunkManager::propagateTorchLightRemoval(Chunk *chunk, i32 x, i32 y, i32 z, i32 lightlevel)
{
    ChunkBlockPos cbpos;
    relativePosToChunkBlockPos(chunk, x, y, z, cbpos);
    if(cbpos.isValid())
...
void ChunkManager::processLightQueue()
{
    ChunkBlockPos cbpos;
...
void ChunkManager::processLightRemovalQueue()
{
    ChunkBlockPos cbpos;
